export default function SobreNosotros() {
  return (
    <section id="sobre-nosotros" className="max-w-4xl mx-auto p-6 my-10 bg-white rounded-lg shadow-md border-t-4 border-amber-500">
      <h2 className="text-3xl font-bold mb-4 text-gray-800 center-">Alquilapp Car</h2>
